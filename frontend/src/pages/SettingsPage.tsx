...
import { SpeakerPersonaField } from './settings/SpeakerPersonaField';
import { useSpeakerPreview } from './settings/useSpeakerPreview';
...
export default function SettingsPage() {
  ...
  const speakerPreview = useSpeakerPreview();
  const previewLabels = {
    play: t('settings.speakerPreviewPlay'),
    playing: t('settings.speakerPreviewStop'),
    loading: t('settings.speakerPreviewLoading'),
  };
  ...
  const audiocppVoiceLabels = {
    ...
    uploadDone: (seconds: number) => t('settings.audiocppVoiceRefDone').replace('{seconds}', String(seconds)),
    transcript: t('settings.audiocppVoiceRefTranscript'),
    transcriptPlaceholder: t('settings.audiocppVoiceRefTranscriptPlaceholder'),
    transcriptHint: t('settings.audiocppVoiceRefTranscriptHint'),
    transcriptSaved: t('settings.audiocppVoiceRefTranscriptSaved'),
    note: {
