                  ...
                  {editingId === c.id ? (
                    <div className="mt-0.5 space-y-1">
                      <textarea
                        ...
                        maxLength={2000}
                        className="h-[600px] w-full resize-none overflow-y-auto rounded border border-sky-200 dark:border-sky-700/40 bg-white dark:bg-sky-900/30 px-2 py-1 text-[11px] text-sky-900 dark:text-sky-100 focus:outline-none focus:ring-1 focus:ring-sky-600/60"
                      />
                      {(() => {
