...
function aiSettingsResponse(accountId: string, isAdmin: boolean, request: FastifyRequest) {
  ...
  const response: Record<string, unknown> = {
    ...
    has_qwen_key: hasProviderKey(runtime, 'qwen'),
    ...
    image_provider: runtime.imageProvider,
    openai_image_model: runtime.openaiImageModel,
    gemini_image_model: runtime.geminiImageModel,
    qwen_image_backend: runtime.qwenImageBackend,
    qwen_api_key: runtime.qwenApiKey,
    qwen_base_url: runtime.qwenBaseUrl,
    qwen_image_model: runtime.qwenImageModel,
...
export async function registerAdminRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.patch('/api/system/ai-settings', async (request, reply) => {
    ...
    const next = {
      ...
      openaiImageModel: data.openai_image_model,
      geminiImageModel: data.gemini_image_model,
      qwenImageBackend: data.qwen_image_backend,
      qwenApiKey: data.qwen_api_key,
      qwenBaseUrl: data.qwen_base_url,
      qwenImageModel: data.qwen_image_model,
